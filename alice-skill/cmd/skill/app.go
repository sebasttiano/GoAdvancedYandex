...
import (
	...
	"github.com/sebasttiano/alice-skill/internal/logger"
	"github.com/sebasttiano/alice-skill/internal/models"
	"github.com/sebasttiano/alice-skill/internal/store"
	"go.uber.org/zap"
)
...
func (a *app) webhook(w http.ResponseWriter, r *http.Request) {
	...
	case strings.HasPrefix(req.Request.Command, "Отправь"):
		...
		if err != nil {
			logger.Log.Debug("cannot save message", zap.String("recipient", recepientID), zap.Error(err))
			w.WriteHeader(http.StatusInternalServerError)
			return
		}
